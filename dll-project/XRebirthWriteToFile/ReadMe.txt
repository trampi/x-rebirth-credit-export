========================================================================
    DYNAMIC LINK LIBRARY: XRebirthWriteToFile-Projektübersicht
========================================================================

Diese XRebirthWriteToFile-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre XRebirthWriteToFile-Anwendung besteht.


XRebirthWriteToFile.vcxproj
...
XRebirthWriteToFile.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen XRebirthWriteToFile.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
